  ...
  try {
    ...
    await client.query(
      `INSERT INTO company_settings (
         ...
         default_tax_rate, default_payment_terms, default_invoice_notes, document_logos, updated_at
      ...
      [
        ...
        num(cs.paymentOrderSequenceNumber, 1000),
    ...
    for (const inv of invoices) {
      ...
      await client.query(
        `INSERT INTO invoices (
           ...
           item_columns, created_at, updated_at
