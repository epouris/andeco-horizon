...
async function loadPayload(pool, opts) {
  ...
  payload.invoices = invoices.rows.map((inv) => ({
    ...
    documentType: inv.document_type === 'proforma' ? 'proforma' : 'invoice',
  ...
  try {
    ...
    await client.query(
      `INSERT INTO company_settings (
         ...
         proforma_sequence_number, default_tax_rate, default_payment_terms, default_invoice_notes,
    ...
    for (const inv of invoices) {
      ...
      await client.query(
        ...
        [
          ...
          str(inv.documentType === 'proforma' ? 'proforma' : 'invoice', 'invoice'),
