...
- **Learning (LMS):** Full learning platform covering course management, user/learner management, content delivery (text/video/links/documents), assessments, announcements, tracking & reports, certificates, and mobile-friendly access. Public course catalog (`#lms-public`) for visitors to request/buy training. Careers portal (`#lms-careers`) for hiring applicants to take a pre-hire exam with an access code.
